...
},
{
    type:"input",
        ...
        name:"departmentName", when: (answers) => answers.responseSelection == 10,
},
{
    type:"input",
        message:"Title of Role",
        name:"roleTitle", when: (answers) => answers.responseSelection == 11
},
{
    type:"input",
        message:"Set Salary for Position",
        name:"roleSalary", when: (answers) => answers.responseSelection == 11
},
{
    type:"list",
